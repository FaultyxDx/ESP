package org.xyz.aoscheat.services;

import static org.xyz.aoscheat.services.CheatOverlay.getConfig;
...
public class ESPView extends View implements Runnable {
    ...
    protected void onDraw(Canvas canvas) {
        if (canvas != null && getVisibility() == VISIBLE) {
            ClearCanvas(canvas);
            CheatOverlay.DrawOn(this, canvas);
        }
    }
